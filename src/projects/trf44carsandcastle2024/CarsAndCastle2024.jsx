      ...
      <div className="min-h-screen bg-[#141414]">
        <div className="text-sm breadcrumbs pt-[65px] text-[#CFC0AE] font-SmolBoy pl-2">
          <ul>
            ...
            <li>
              <p className="cursor-default">Cars and Castle 2024</p>
            </li>
          </ul>
        </div>
        <div className="text-[#CFC0AE] flex flex-col items-center justify-center mt-8">
          <h2 className="font-BigBoy font-black text-3xl lg:text-5xl xl:text-6xl tracking-wide text-center">Cars and Castle 2024</h2>
...
export default CarsAndCastle2024;
